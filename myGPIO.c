...
{
    GPIO_getInputPinValue(GPIO_PORT_P5,GPIO_PIN1);
...
void turnOn_LaunchpadLED1()
{
    ...
    //return (GPIO_setOutputHighOnPin(GPIO_PORT_P1,GPIO_PIN0));
}
...
{
    GPIO_setOutputLowOnPin(GPIO_PORT_P1,GPIO_PIN0);
    //return (GPIO_setOutputLowOnPin(GPIO_PORT_P1,GPIO_PIN0));
}
